// src/app/services/social-media/components/CTA.tsx
'use client';
        ...
        <div className="max-w-4xl mx-auto text-center">
          ...
          >
            <h2 className="text-5xl md:text-6xl lg:text-7xl font-bold text-white">
              Ready to <span className="text-primary">Elevate</span> Your Social Presence?
            </h2>
            ...
            >
              ...
              <div>
                ...
                <div className="text-gray-400">Community Management</div>
              </div>
            </motion.div> */}
          </motion.div>
        </div>
